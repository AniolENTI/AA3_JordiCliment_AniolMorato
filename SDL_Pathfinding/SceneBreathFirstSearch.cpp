#include "SceneBreathFirstSearch.h"
...
SceneBreathFirstSearch::SceneBreathFirstSearch()
{
	...
	//frontier = agents[0].BreathFirstSearch
}
...
void SceneBreathFirstSearch::update(float dtime, SDL_Event* event)
{
...
void SceneBreathFirstSearch::draw()
{
	drawMaze();
	drawCoin();
...
void SceneBreathFirstSearch::drawCoin()
{
...
bool SceneBreathFirstSearch::loadTextures(char* filename_bg, char* filename_coin)
{
